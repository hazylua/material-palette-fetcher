...
declare module '$env/static/private' {
	...
	export const AVISYNTH_SDK_PATH: string;
	...
	export const ER_AUTO_LOC: string;
	export const ER_BKP_LOC: string;
	export const ER_SAVE_LOC: string;
	...
	export const SNG_SERVICE: string;
	...
	export const WWISEROOT: string;
	export const WWISESDK: string;
